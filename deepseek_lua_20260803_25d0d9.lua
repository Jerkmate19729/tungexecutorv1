--[[
    Tung Executor v2 – Centered & Bulletproof for Mobile
]]
...
screenGui.IgnoreGuiInset = true   -- helps with edge hugging
screenGui.Parent = playerGui

-- ========================================================================
--  MAIN FRAME – Centered using scale (no absolute offsets)
-- ========================================================================

local mainFrame = Instance.new("Frame")
-- Use a large portion of the screen, with a max size for tablets/phones
mainFrame.Size = UDim2.new(0.85, 0, 0.75, 0)    -- 85% width, 75% height
mainFrame.Position = UDim2.new(0.075, 0, 0.125, 0)  -- centered (7.5% left, 12.5% top)
mainFrame.BackgroundColor3 = Color3.fromHex("1A1A1A")
mainFrame.BackgroundTransparency = 0     -- fully opaque for visibility
mainFrame.BorderSizePixel = 0
mainFrame.ClipsDescendants = true
mainFrame.Parent = screenGui

-- Rounded corners and neon border
...
-- Close & Minimize buttons (solid backgrounds for easy tapping)
...
local minButton = makeTitleBtn("─", -68, Color3.fromHex("333333"))
local closeButton = makeTitleBtn("✕", -34, Color3.fromHex("CC3333"))
...
controlsStrip.Size = UDim2.new(1, 0, 0, 36)
...
local execBtn = createBtn("Execute", Color3.fromHex("00E676"), function() executeScript() end)
-- Glow stroke
...
local clearBtn = createBtn("Clear", Color3.fromHex("D32F2F"), function() clearConsole() end)
local killBtn = createBtn("Kill", Color3.fromHex("FFB300"), function() killScript() end)

-- Output Panel (40%)
local outputPanel = Instance.new("Frame")
outputPanel.Size = UDim2.new(1, 0, 0.4, -4)
...
-- ========================================================================
--  DRAGGING (Title Bar & Mobile button) – using Touch and Mouse
-- ========================================================================
...
-- ========================================================================
--  FLOATING MOBILE BUTTON (fully draggable, toggle)
-- ========================================================================
...
-- Toggle main frame on click/tap
...
addConsoleLine("Tap the ⚡ button to show/hide.", "AAAAAA")
