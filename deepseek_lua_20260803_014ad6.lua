--[[
    Tung Executor v2 – Ultra‑visible Mobile Edition
    Guaranteed to appear on screen. All features included.
]]
...
-- Create a ScreenGui with high display order
...
mainFrame.Size = UDim2.new(0, 750, 0, 550)   -- bigger
mainFrame.Position = UDim2.new(0.5, -375, 0.5, -275)
mainFrame.AnchorPoint = Vector2.new(0.5, 0.5)
mainFrame.BackgroundColor3 = Color3.fromHex("1A1A1A")   -- solid dark
...
-- ============================================================
--  KEYBOARD SHORTCUTS (work on iPad if keyboard attached)
-- ============================================================
...
-- ============================================================
--  DRAGGING (works with touch & mouse)
-- ============================================================
...
-- ============================================================
--  DEBUG: Show a welcome message in console
-- ============================================================
