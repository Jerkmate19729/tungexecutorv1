--[[
    Tung Executor v2 – Clean & Functional for Mobile
    Looks like Potassium, works like a premium executor.
]]
...
-- ============================================================
--  MAIN FRAME – Centered with scale
-- ============================================================

local mainFrame = Instance.new("Frame")
mainFrame.Size = UDim2.new(0.85, 0, 0.75, 0)    -- 85% width, 75% height
mainFrame.Position = UDim2.new(0.075, 0, 0.125, 0)  -- centered
mainFrame.BackgroundColor3 = Color3.fromHex("1A1A1A") -- dark background
mainFrame.BackgroundTransparency = 0
mainFrame.BorderSizePixel = 0
mainFrame.ClipsDescendants = true
mainFrame.Parent = screenGui

-- Corners & border (neon orange accent)
...
-- ============================================================
--  TITLE BAR (draggable, with close/minimize)
-- ============================================================
...
-- ============================================================
--  CONTENT: Input (top) and Output (bottom)
-- ============================================================
...
-- Buttons strip (between input and output)
...
-- Helper to create buttons (solid, cornered)
...
-- ============================================================
--  FLOATING MOBILE BUTTON (draggable, toggle)
-- ============================================================
...
addConsoleLine("Type your script, press Execute or Ctrl+Enter.", "AAAAAA")
